       ...
       jogador.reiniciar();
        ...
        acao = opcao(acao);
				...
				switch(acao) {
					...
					case 2: jogador.tomarPocaoDeCura();
							System.out.print("\n[ Pocão Ok ]"); 
							break;

					case 3: turno = jogador.fortificar(inimigo, turno);
							System.out.print("\n[ Fortificado ]"); 
							break;
				}
          ...
          System.out.print("\ncomando invalido...");
			   ...
			   switch(acao) {
					...
					case 1: inimigo.atacar(jogador);
							System.out.print("\n\n[ Você é atacado com sucesso ]");
							break;

					case 2:	inimigo.recuperacao();
							System.out.print("\n\n[ O inimigo foi recuperado ]");
							break;
		
					case 3: turno = inimigo.endurecer(jogador, turno);
			...
			System.out.print("\n" + jogador.toString());
			System.out.print("\n" + inimigo.toString() + "\n");
      if((inimigo.getHp() <= 0)) jogador.setRanking(jogador.getRanking()+2);
